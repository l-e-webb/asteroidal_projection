...
public class FireAtTarget extends EnemyGun {
    ...
    public FireAtTarget(float x, float y, float width, float height, SteerableObject target, FireRate rate, Weapon weapon, float range, TextureRegion texture, boolean rotateWithShot) {
    ...
    public FireAtTarget(float x, float y, SteerableObject target, FireRate rate, Weapon weapon, float range) {
