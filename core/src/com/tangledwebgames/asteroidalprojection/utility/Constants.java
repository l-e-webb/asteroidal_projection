...
public class Constants {
    ...
    public static final float SEEKER_CANNON_OFFSET_X = 0f;
    public static final float SEEKER_CANNON_OFFSET_Y = -0.06f;
    public static final float FLY_BY_CANNON_OFFSET_X = 0f;
    public static final float FLY_BY_CANNON_OFFSET_Y = -0.03f;
    public static final float SNIPER_CANNON_OFFSET_X = 0f;
    public static final float SNIPER_CANNON_OFFSET_Y = -0.06f;
